    ...
    <main className="download-page">
      ...
      <section className="download-shell" aria-labelledby="download-title">
        ...
        <div className="download-actions">
          <a className="download-install" href="/downloads/alpha-trader-ai.apk?v=1.4.10" download>
        ...
        <p className="download-footnote">Android 7 及以上 · v1.4.10 已签名发布版 · 支持账号登录与自动续签</p>
      </section>
    </main>
  );
}
